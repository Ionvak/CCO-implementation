...
public class TreeParams {
    ...
    public TreeParams(double viscosity, double bifExponent, double distalPress, double perfPress, double perfFlow, double termFlow, double perfRadius, int nTerminal) {
